        ...
        <SimpleBar style={{ height: "900px" }}>
          <div data-simplebar className="h-100">
            ...
            <div className="p-4">
              ...
              <h6 className="text-center">Theme Layouts</h6>

              <div className="mb-2">
                <img src={layout1} className="img-fluid img-thumbnail" alt="Light Layout" />
              </div>

              <div className="mb-2">
                <img src={layout2} className="img-fluid img-thumbnail" alt="Dark Layout" />
              </div>

              <div className="mb-2">
                <img src={layout3} className="img-fluid img-thumbnail" alt="RTL Layout" />
              </div>
            </div>
          </div>
        </SimpleBar>
