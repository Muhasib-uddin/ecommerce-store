    ...
    return (
        <React.Fragment>
            <Row>
                <Col lg={4}>
                    <Card>
                        <img className="card-img img-fluid" src={img5} alt="Store" />
                        <CardBody>
                ...
                <Col lg={4}>
                    <Card>
                        ...
                        <img className="card-img img-fluid" src={img7} alt="Store" />
                    </Card>
                </Col>

                <Col lg={4}>
                    <Card>
                        <img className="card-img img-fluid" src={img6} alt="Store" />
