...
const EcommerceProductDetail = props => {
  ...
  //meta title
  document.title = "Product Details | Admin Dashboard";
                    ...
                    <Row>
                      ...
                      <Col xl="6">
                        <div className="mt-4 mt-xl-3">
                          ...
                          <h5 className="mb-4">
                            Price :{" "}
                            {product.oldPrice && parseFloat(product.oldPrice) > parseFloat(product.newPrice) && (
                              <span className="text-muted me-2">
                                <del>{formatCurrency(product.oldPrice)}</del>
                              </span>
                            )}{" "}
                            <b>{formatCurrency(product.newPrice)}</b>
                          </h5>
                          <p className="text-muted mb-4">
