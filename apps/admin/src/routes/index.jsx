...
// New Custom Admin Pages
import StorefrontTheme from "../pages/Storefront/StorefrontTheme";
...
import FlashSales from "../pages/Promotions/FlashSales";
import BlogManager from "../pages/Content/BlogManager";
import PageManager from "../pages/Content/PageManager";
import NavigationManager from "../pages/Content/NavigationManager";
...
const authProtectedRoutes = [
  // Storefront
  { path: "/storefront/theme", component: <StorefrontTheme /> },
  { path: "/storefront/homepage", component: <StorefrontHomepage /> },

  // Promotions
  { path: "/promotions/coupons", component: <Coupons /> },
  { path: "/promotions/discounts", component: <Discounts /> },
  { path: "/promotions/flash-sales", component: <FlashSales /> },

  // Content
  { path: "/content/blog", component: <BlogManager /> },
  { path: "/content/pages", component: <PageManager /> },
  { path: "/content/navigation", component: <NavigationManager /> },
  { path: "/content/popups", component: <PopupManager /> },
  ...
  { path: "/ecommerce-categories", component: <CategoryList /> },
  ...
  { path: "/ecommerce-add-product/:id", component: <EcommerenceAddProduct /> },
